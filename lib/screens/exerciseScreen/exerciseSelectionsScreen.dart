...
class _ExerciseSelectionsScreenState extends State<ExerciseSelectionsScreen> {
  ...
  void selectExerciseHandler(arms, legs, hips) {
    ...
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => ExerciseScreen(compileEx)));
  }
                ...
                child: InkWell(
                  ...
                  child: Container(
                    child: ClipRRect(
                      ...
                      child: _arms
                          ? Image.asset('assets/icons/arm.png',
                              gaplessPlayback: true)
                          : Image.asset('assets/icons/arm-off.png',
                              gaplessPlayback: true),
                    ),
                  ),
                ),
                ...
                child: InkWell(
                  ...
                  child: Container(
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(20.0),
                      child: _hips
                          ? Image.asset('assets/icons/hip.png',
                              gaplessPlayback: true)
                          : Image.asset('assets/icons/hip-off.png',
                              gaplessPlayback: true),
                    ),
                  ),
                ),
                ...
                child: InkWell(
                  ...
                  child: Container(
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(20.0),
                      child: _legs
                          ? Image.asset('assets/icons/leg.png',
                              gaplessPlayback: true)
                          : Image.asset('assets/icons/leg-off.png',
                              gaplessPlayback: true),
                    ),
                  ),
                ),
